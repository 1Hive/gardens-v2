...
import { newLogo, PoweredBy, commF } from "@/assets";
  ...
  return (
    <div className="relative overflow-hidden ">
      ...
      <div className="isolate overflow-hidden bg-linear-to-b from-indigo-100/20 pt-2 ">
        ...
        />
        <div className="mx-auto max-w-7xl px-6 py-32 xl:py-40 lg:px-8">
          <motion.div
          ...
          >
            ...
            <h1 className="max-w-2xl text-4xl xl:5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl lg:col-span-2 xl:col-auto  ">
              Planting the seeds for the public economy
            </h1>
            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
              <p className="text-md lg:text-lg text-pretty sm:text-xl/8">
          ...
          <div className="lg:-mt-20 flex items-center justify-center w-full ">
            <ChevronDoubleDownIcon className="w-5 h-5 animate-bounce" />
          </div>
          <div className="mt-8 lg:-mt-10 rounded-3xl py-2 px-6 h-fit hover:text-primary-content hover:bg-neutral-soft-3 transition-all duration-300 ease-in-out lg:text-left bg-neutral-soft-2 lg:w-fit text-center w-full">
            <a
      ...
      {/* <div className="relative isolate overflow-hidden py-20 ">
        ...
        <div className="mx-auto max-w-7xl px-6 py-8 lg:px-8 ">
          <motion.div
            className="max-w-2xl  bg-neutral-soft-2 rounded-3xl p-8 pr-16 "
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              duration: 0.3,
