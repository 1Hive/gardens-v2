...
const PoolCard = ({ name, strategy, proposals }: any) => {
  return (
    <>
      <Link
        className="min-w-56 relative flex h-full w-56 shrink-0 snap-center flex-col items-start rounded-md border-2 border-black"
        href={"/#"}
      >
