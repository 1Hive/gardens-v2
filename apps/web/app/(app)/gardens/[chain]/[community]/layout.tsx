...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-full flex-1 flex-col gap-4 overflow-x-visible bg-primary">
      ...
      {/* Main Content */}
      <main className="container z-10 mx-auto mt-10 flex w-full flex-1 flex-col p-6 xl:max-w-7xl">
