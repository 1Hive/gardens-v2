...
export const MarkeeAbi = [
  ...
  },
  {
    ...
    name: "createMarkee",
    outputs: [
      { internalType: "address", name: "markeeAddress", type: "address" },
    ],
    stateMutability: "payable",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newMaxLength", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newMinimumPrice", type: "uint256" },
    ],
