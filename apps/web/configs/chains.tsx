...
import SubgraphConfig from "./subgraph.json";
...
const SUBGRAPH_TESTNET_VERSION = SubgraphConfig.VERSION_TESTNET;
const SUBGRAPH_PRODNET_VERSION = SubgraphConfig.VERSION_PROD;
