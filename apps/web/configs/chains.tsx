...
const SUBGRAPH_TESTNET_VERSION = "0.21";
...
export const chainConfigMap: {
  ...
  421614: {
    ...
    subgraphUrl: `${process.env.NEXT_PUBLIC_SUBGRAPH_URL_ARB_SEP!}/${SUBGRAPH_TESTNET_VERSION}`,
    globalTribunal: "0xb05A948B5c1b057B88D381bDe3A375EfEA87EbAD",
  ...
  11155111: {
    ...
    subgraphUrl: `${process.env.NEXT_PUBLIC_SUBGRAPH_URL_ETH_SEP!}/${SUBGRAPH_TESTNET_VERSION}`,
  ...
  42161: {
    ...
    subgraphUrl: `${process.env.NEXT_PUBLIC_SUBGRAPH_URL_ARBITRUM!}/${SUBGRAPH_PRODNET_VERSION}`,
  ...
  10: {
    ...
    subgraphUrl: `${process.env.NEXT_PUBLIC_SUBGRAPH_URL_OPTIMISM!}/${SUBGRAPH_PRODNET_VERSION}`,
    globalTribunal: "0x1B8C7f06F537711A7CAf6770051A43B4F3E69A7e",
    allo: "0x1133eA7Af70876e64665ecD07C0A0476d09465a1",
  ...
  137: {
    ...
    subgraphUrl: `${process.env.NEXT_PUBLIC_SUBGRAPH_URL_MATIC!}/${SUBGRAPH_PRODNET_VERSION}`,
    globalTribunal: "0x1B8C7f06F537711A7CAf6770051A43B4F3E69A7e",
    allo: "0x1133eA7Af70876e64665ecD07C0A0476d09465a1",
  ...
  100: {
    ...
    subgraphUrl: `${process.env.NEXT_PUBLIC_SUBGRAPH_URL_GNOSIS!}/${SUBGRAPH_PRODNET_VERSION}`,
    globalTribunal: "0x1B8C7f06F537711A7CAf6770051A43B4F3E69A7e",
    allo: "0x",
    arbitrator: "0x",
    passportScorer: "0x",
  ...
  1: {
    ...
    subgraphUrl: `${process.env.NEXT_PUBLIC_SUBGRAPH_URL_ETHEREUM!}/${SUBGRAPH_PRODNET_VERSION}`,
    globalTribunal: "0x",
    allo: "0x",
    arbitrator: "0x",
    passportScorer: "0x",
