...
| Medium       | 6     | M-1 (carry-over), M-2 (new — PowerManagementUtils arithmetic), M-3 (carry-over), M-4 (carry-over + new nested loop), M-5 (new — cooldown/partial), M-6 (new — rebalance permissionless, cooldown griefing) |
