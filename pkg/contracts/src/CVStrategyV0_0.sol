    ...
    ERC165
{
    ...
    function calculateThreshold(
        ...
        _threshold = _threshold > minThresholdPoints
            ? _threshold
            : minThresholdPoints;
    }
    ...
    function setMinThresholdPoints(
        uint256 minThresholdPoints_
    ) external onlyPoolManager(msg.sender) {
    ...
    function setPoolParams(bytes memory data) public {
        ...
        if (
            ...
            arbitrableConfig.submitterCollateralAmount = _arbitrableConfig
        ...
        if (
            ...
            arbitrableConfig.challengerCollateralAmount = _arbitrableConfig
        ...
        if (
            ...
            arbitrableConfig.defaultRulingTimeout
        ) {
            arbitrableConfig.defaultRulingTimeout = _arbitrableConfig
                .defaultRulingTimeout;
        }

        if (
            _arbitrableConfig.collateralVaultTemplate !=
            arbitrableConfig.collateralVaultTemplate
        ) {
            arbitrableConfig.collateralVaultTemplate = _arbitrableConfig
    ...
    function registerTribunalSafe(address _tribunalSafe) external {
        onlyCouncilSafe();
        SafeArbitrator(address(arbitrableConfig.arbitrator)).registerSafe(
            _tribunalSafe
        );
        emit TribunaSafeRegistered(
            address(this),
