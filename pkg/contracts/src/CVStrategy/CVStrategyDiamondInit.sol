...
// Customized DiamondInit for CVStrategy to register CVStrategy-specific interfaces
...
contract CVStrategyDiamondInit {
    function init() external {
        ...
        // Register CVStrategy-specific interfaces
        ds.supportedInterfaces[type(IArbitrable).interfaceId] = true;
    }
}
