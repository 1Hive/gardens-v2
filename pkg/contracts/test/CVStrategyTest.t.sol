...
contract CVStrategyTest is Test, AlloSetup, RegistrySetupFull, CVStrategyHelpers, Errors, GasHelpers2, SafeSetup {
    ...
    function _assertProposalStatus(CVStrategyV0_1 cv, uint256 proposalId, StrategyStruct.ProposalStatus _toBeChecked)
        internal
        view
    {
        (
    ...
    function testRevert_allocate_senderZero() public {
        ...
        votes[0] = StrategyStruct.ProposalSupport(proposalId, int256(PRECISE_FIVE_PERCENT));
        bytes memory data = abi.encode(votes);
