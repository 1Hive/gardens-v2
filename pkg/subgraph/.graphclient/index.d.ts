...
export type CVProposal_orderBy = 'id' | 'proposalMeta' | 'proposalMeta__id' | 'proposalMeta__version' | 'proposalMeta__title' | 'proposalMeta__content' | 'metadata' | 'version' | 'strategy' | 'strategy__id' | 'strategy__poolId' | 'beneficiary' | 'requestedAmount' | 'requestedToken' | 'proposalStatus' | 'blockLast' | 'convictionLast' | 'threshold' | 'proposalType' | 'stakedTokens' | 'submitter' | 'voterStakedPointsPct' | 'agreementActionId' | 'createdAt' | 'updatedAt';
