...
export type AlloResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["Allo"] = ResolversParentTypes["Allo"]
> = ResolversObject<{
...
export type PassportScorerResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["PassportScorer"] = ResolversParentTypes["PassportScorer"]
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  strategies?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<PassportScorerstrategiesArgs, "skip" | "first">
  >;
  users?: Resolver<
    Maybe<Array<ResolversTypes["PassportUser"]>>,
    ParentType,
    ContextType,
    RequireFields<PassportScorerusersArgs, "skip" | "first">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
> = ResolversObject<{
  ...
  >;
  passportScorer?: Resolver<
    Maybe<ResolversTypes["PassportScorer"]>,
    ParentType,
    ContextType,
    RequireFields<QuerypassportScorerArgs, "id" | "subgraphError">
  >;
  passportScorers?: Resolver<
    Array<ResolversTypes["PassportScorer"]>,
    ParentType,
    ContextType,
    RequireFields<QuerypassportScorersArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  cvstrategy?: SubscriptionResolver<
    Maybe<ResolversTypes["CVStrategy"]>,
    "cvstrategy",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncvstrategyArgs, "id" | "subgraphError">
  >;
  cvstrategies?: SubscriptionResolver<
    Array<ResolversTypes["CVStrategy"]>,
    "cvstrategies",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptioncvstrategiesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  cvstrategyConfig?: SubscriptionResolver<
    Maybe<ResolversTypes["CVStrategyConfig"]>,
    "cvstrategyConfig",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncvstrategyConfigArgs, "id" | "subgraphError">
  >;
  cvstrategyConfigs?: SubscriptionResolver<
    Array<ResolversTypes["CVStrategyConfig"]>,
    "cvstrategyConfigs",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptioncvstrategyConfigsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  arbitrableConfig?: SubscriptionResolver<
    Maybe<ResolversTypes["ArbitrableConfig"]>,
    "arbitrableConfig",
    ParentType,
    ContextType,
    RequireFields<SubscriptionarbitrableConfigArgs, "id" | "subgraphError">
  >;
  arbitrableConfigs?: SubscriptionResolver<
    Array<ResolversTypes["ArbitrableConfig"]>,
    "arbitrableConfigs",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionarbitrableConfigsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  cvproposal?: SubscriptionResolver<
    Maybe<ResolversTypes["CVProposal"]>,
    "cvproposal",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncvproposalArgs, "id" | "subgraphError">
  >;
  cvproposals?: SubscriptionResolver<
    Array<ResolversTypes["CVProposal"]>,
    "cvproposals",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptioncvproposalsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  registryFactory?: SubscriptionResolver<
    Maybe<ResolversTypes["RegistryFactory"]>,
    "registryFactory",
    ParentType,
    ContextType,
    RequireFields<SubscriptionregistryFactoryArgs, "id" | "subgraphError">
  >;
  registryFactories?: SubscriptionResolver<
    Array<ResolversTypes["RegistryFactory"]>,
    "registryFactories",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionregistryFactoriesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  registryCommunity?: SubscriptionResolver<
    Maybe<ResolversTypes["RegistryCommunity"]>,
    "registryCommunity",
    ParentType,
    ContextType,
    RequireFields<SubscriptionregistryCommunityArgs, "id" | "subgraphError">
  >;
  registryCommunities?: SubscriptionResolver<
    Array<ResolversTypes["RegistryCommunity"]>,
    "registryCommunities",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionregistryCommunitiesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  ...
  >;
  stake?: SubscriptionResolver<
    Maybe<ResolversTypes["Stake"]>,
    "stake",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstakeArgs, "id" | "subgraphError">
  >;
  stakes?: SubscriptionResolver<
    Array<ResolversTypes["Stake"]>,
    "stakes",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstakesArgs, "skip" | "first" | "subgraphError">
  >;
  memberCommunity?: SubscriptionResolver<
    Maybe<ResolversTypes["MemberCommunity"]>,
    "memberCommunity",
    ParentType,
    ContextType,
    RequireFields<SubscriptionmemberCommunityArgs, "id" | "subgraphError">
  >;
  memberCommunities?: SubscriptionResolver<
    Array<ResolversTypes["MemberCommunity"]>,
    "memberCommunities",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionmemberCommunitiesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  memberStrategy?: SubscriptionResolver<
    Maybe<ResolversTypes["MemberStrategy"]>,
    "memberStrategy",
    ParentType,
    ContextType,
    RequireFields<SubscriptionmemberStrategyArgs, "id" | "subgraphError">
  >;
  memberStrategies?: SubscriptionResolver<
    Array<ResolversTypes["MemberStrategy"]>,
    "memberStrategies",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionmemberStrategiesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  tokenGarden?: SubscriptionResolver<
    Maybe<ResolversTypes["TokenGarden"]>,
    "tokenGarden",
    ParentType,
    ContextType,
    RequireFields<SubscriptiontokenGardenArgs, "id" | "subgraphError">
  >;
  tokenGardens?: SubscriptionResolver<
    Array<ResolversTypes["TokenGarden"]>,
    "tokenGardens",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptiontokenGardensArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  allo?: SubscriptionResolver<
    Maybe<ResolversTypes["Allo"]>,
    "allo",
    ParentType,
    ContextType,
    RequireFields<SubscriptionalloArgs, "id" | "subgraphError">
  >;
  allos?: SubscriptionResolver<
    Array<ResolversTypes["Allo"]>,
    "allos",
    ParentType,
    ContextType,
    RequireFields<SubscriptionallosArgs, "skip" | "first" | "subgraphError">
  >;
  passportScorer?: SubscriptionResolver<
    Maybe<ResolversTypes["PassportScorer"]>,
    "passportScorer",
    ParentType,
    ContextType,
    RequireFields<SubscriptionpassportScorerArgs, "id" | "subgraphError">
  >;
  passportScorers?: SubscriptionResolver<
    Array<ResolversTypes["PassportScorer"]>,
    "passportScorers",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionpassportScorersArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  passportStrategy?: SubscriptionResolver<
    Maybe<ResolversTypes["PassportStrategy"]>,
    "passportStrategy",
    ParentType,
    ContextType,
    RequireFields<SubscriptionpassportStrategyArgs, "id" | "subgraphError">
  >;
  passportStrategies?: SubscriptionResolver<
    Array<ResolversTypes["PassportStrategy"]>,
    "passportStrategies",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionpassportStrategiesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  passportUser?: SubscriptionResolver<
    Maybe<ResolversTypes["PassportUser"]>,
    "passportUser",
    ParentType,
    ContextType,
    RequireFields<SubscriptionpassportUserArgs, "id" | "subgraphError">
  >;
  passportUsers?: SubscriptionResolver<
    Array<ResolversTypes["PassportUser"]>,
    "passportUsers",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionpassportUsersArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  proposalDispute?: SubscriptionResolver<
    Maybe<ResolversTypes["ProposalDispute"]>,
    "proposalDispute",
    ParentType,
    ContextType,
    RequireFields<SubscriptionproposalDisputeArgs, "id" | "subgraphError">
  >;
  proposalDisputes?: SubscriptionResolver<
    Array<ResolversTypes["ProposalDispute"]>,
    "proposalDisputes",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionproposalDisputesArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  proposalDisputeMetadata?: SubscriptionResolver<
    Maybe<ResolversTypes["ProposalDisputeMetadata"]>,
    "proposalDisputeMetadata",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionproposalDisputeMetadataArgs,
      "id" | "subgraphError"
    >
  >;
  proposalDisputeMetadata_collection?: SubscriptionResolver<
    Array<ResolversTypes["ProposalDisputeMetadata"]>,
    "proposalDisputeMetadata_collection",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionproposalDisputeMetadata_collectionArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  proposalMetadata?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionproposalMetadataArgs, "id" | "subgraphError">
  >;
  proposalMetadata_collection?: SubscriptionResolver<
    Array<ResolversTypes["ProposalMetadata"]>,
    "proposalMetadata_collection",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionproposalMetadata_collectionArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  collateralVault?: SubscriptionResolver<
    Maybe<ResolversTypes["CollateralVault"]>,
    "collateralVault",
    ParentType,
    ContextType,
    RequireFields<SubscriptioncollateralVaultArgs, "id" | "subgraphError">
  >;
  collateralVaults?: SubscriptionResolver<
    Array<ResolversTypes["CollateralVault"]>,
    "collateralVaults",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptioncollateralVaultsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  collateralVaultDeposit?: SubscriptionResolver<
    Maybe<ResolversTypes["CollateralVaultDeposit"]>,
    "collateralVaultDeposit",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptioncollateralVaultDepositArgs,
      "id" | "subgraphError"
    >
  >;
  collateralVaultDeposits?: SubscriptionResolver<
    Array<ResolversTypes["CollateralVaultDeposit"]>,
    "collateralVaultDeposits",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptioncollateralVaultDepositsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
...
>(
  ...
  getPassportScorer(
    ...
    options?: TOperationContext
  ): Promise<getPassportScorerQuery>;
  getPassportStrategy(
    variables: Exact<{
      strategyId: string;
    }>,
      ...
      stakes?: Maybe<
        Array<
          Pick<Stake, "id" | "amount"> & {
            proposal: Pick<
              CVProposal,
              "id" | "proposalNumber" | "stakedAmount"
            > & {
...
export type getProposalDataQuery = {
  ...
  cvproposal?: Maybe<
    ...
    > & {
      ...
      strategy: Pick<
        CVStrategy,
        "id" | "token" | "maxCVSupply" | "totalEffectiveActivePoints" | "poolId"
      > & {
        config: Pick<
          CVStrategyConfig,
...
export type getStrategyByPoolQuery = {
  cvstrategies: Array<
    Pick<
      CVStrategy,
      "id" | "poolId" | "totalEffectiveActivePoints" | "isEnabled"
    > & {
      config: Pick<
        CVStrategyConfig,
...
export type getPassportScorerQuery = {
  passportScorer?: Maybe<
    Pick<PassportScorer, "id"> & {
      strategies?: Maybe<
        Array<
          Pick<
            PassportStrategy,
            "id" | "threshold" | "councilSafe" | "active"
          > & {
            strategy: Pick<CVStrategy, "id">;
          }
        >
...
>;
export declare const getPassportScorerDocument: DocumentNode<
  getPassportScorerQuery,
  Exact<{
    scorerId: Scalars["ID"]["input"];
  }>
>;
