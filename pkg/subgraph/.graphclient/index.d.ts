...
> = ResolversObject<{
  ...
  proposalMeta?: Resolver<
    ResolversTypes["ProposalMeta"],
    ParentType,
    ContextType
  >;
  ...
  voterStakedPointsPct?: Resolver<
    ResolversTypes["BigInt"],
    ParentType,
    ContextType
  >;
  agreementActionId?: Resolver<
    ResolversTypes["BigInt"],
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  ...
  registryCommunity?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MemberregistryCommunityArgs, "skip" | "first">
  >;
...
export type ProposalMetaResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["ProposalMeta"] = ResolversParentTypes["ProposalMeta"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  proposal?: Resolver<
    Array<ResolversTypes["CVProposal"]>,
    ParentType,
    ContextType,
    RequireFields<ProposalMetaproposalArgs, "skip" | "first">
  >;
  version?: Resolver<Maybe<ResolversTypes["BigInt"]>, ParentType, ContextType>;
...
> = ResolversObject<{
  ...
  >;
  proposalMeta?: Resolver<
    Maybe<ResolversTypes["ProposalMeta"]>,
    ParentType,
    ContextType,
    RequireFields<QueryproposalMetaArgs, "id" | "subgraphError">
  >;
  proposalMetas?: Resolver<
    Array<ResolversTypes["ProposalMeta"]>,
    ParentType,
    ContextType,
    RequireFields<QueryproposalMetasArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  ...
  cvproposals?: SubscriptionResolver<
    ...
    >
  >;
  proposalMeta?: SubscriptionResolver<
    Maybe<ResolversTypes["ProposalMeta"]>,
    "proposalMeta",
    ParentType,
    ContextType,
    RequireFields<SubscriptionproposalMetaArgs, "id" | "subgraphError">
  >;
  proposalMetas?: SubscriptionResolver<
    Array<ResolversTypes["ProposalMeta"]>,
    "proposalMetas",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptionproposalMetasArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
...
>(
  ...
  getCommunityByGarden(
    variables: Exact<{
      addr: string;
    }>,
    options?: TOperationContext,
  ): Promise<getCommunityByGardenQuery>;
};
      ...
      registryCommunities?: Maybe<
        Array<
          ...
          > & {
            ...
            strategies?: Maybe<
              Array<
                Pick<CVStrategy, "id" | "poolId"> & {
                  config?: Maybe<
                    Pick<
                      CVStrategyConfig,
                      "id" | "decay" | "maxRatio" | "weight"
                    >
                  >;
                }
              >
...
export type getTokenGardensQuery = {
  tokenGardens: Array<
    Pick<TokenGarden, "id" | "name" | "symbol" | "decimals"> & {
      communities?: Maybe<Array<Pick<RegistryCommunity, "id">>>;
    }
  >;
};
...
export type getCommunityByGardenQuery = {
  tokenGarden?: Maybe<
    Pick<TokenGarden, "id" | "name" | "symbol"> & {
      communities?: Maybe<
        Array<
          Pick<RegistryCommunity, "id" | "communityName"> & {
...
>;
export declare const getCommunityByGardenDocument: DocumentNode<
...
export declare function getSdk<C, E>(
  ...
  getCommunityByGarden(
    variables: getCommunityByGardenQueryVariables,
    options?: C,
  ): Promise<getCommunityByGardenQuery>;
};
