...
> = ResolversObject<{
  ...
  metadata?: Resolver<
    ResolversTypes["ProposalDisputeMetadata"],
    ParentType,
    ContextType
  >;
...
>(
  ...
  getStrategyArbitrationConfig(
    variables: Exact<{
      strategyConfigId: string;
    }>,
    options?: TOperationContext
  ): Promise<getStrategyArbitrationConfigQuery>;
};
...
export type getGardenQuery = {
  tokenGarden?: Maybe<
    Pick<TokenGarden, "id" | "name" | "symbol" | "decimals" | "chainId"> & {
      communities?: Maybe<
        Array<
          Pick<
            RegistryCommunity,
...
export type getCommunityCreationDataQuery = {
  ...
  tokenGarden?: Maybe<
    Pick<TokenGarden, "id" | "name" | "symbol" | "decimals" | "chainId"> & {
      communities?: Maybe<
        Array<Pick<RegistryCommunity, "alloAddress" | "isValid">>
      >;
    }
  >;
};
...
export type getProposalTitlesQuery = {
  cvproposal?: Maybe<
    Pick<CVProposal, "proposalNumber" | "metadata"> & {
...
>;
export declare const getGardenDocument: DocumentNode<
  getGardenQuery,
  Exact<{
    addr: Scalars["ID"]["input"];
  }>
...
>;
export declare const getStrategyArbitrationConfigDocument: DocumentNode<
...
export declare function getSdk<C, E>(
  ...
  getGarden(
    variables: getGardenQueryVariables,
    options?: C
  ): Promise<getGardenQuery>;
  getCommunity(
  ...
  getStrategyArbitrationConfig(
    variables: getStrategyArbitrationConfigQueryVariables,
    options?: C
  ): Promise<getStrategyArbitrationConfigQuery>;
};
