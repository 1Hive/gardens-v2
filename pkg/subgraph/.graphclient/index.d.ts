...
>(
  ...
  getCommunitiesByGarden(
    variables: Exact<{
      addr: string;
    }>,
    options?: TOperationContext,
  ): Promise<getCommunitiesByGardenQuery>;
    ...
    > & {
      communities?: Maybe<
        Array<
          Pick<
            RegistryCommunity,
            "id" | "chainId" | "covenantIpfsHash" | "communityFee"
          > & {
...
>;
export declare const getCommunitiesByGardenDocument: DocumentNode<
...
export declare function getSdk<C, E>(
  ...
  getCommunitiesByGarden(
    variables: getCommunitiesByGardenQueryVariables,
    options?: C,
  ): Promise<getCommunitiesByGardenQuery>;
  getCommunityCreationData(
