name: Web Developer
description: "Use when working on Next.js frontend in apps/web: UI, hooks, providers, routes, wagmi, urql, and integration with contracts and subgraph."
argument-hint: "Next.js, wagmi, urql, UI"
user-invocable: true
target: workspace
---
